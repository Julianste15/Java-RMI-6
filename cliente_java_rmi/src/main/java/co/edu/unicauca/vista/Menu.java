...
public class Menu {
    ...
    private void opcion1() {
        ...
        try {
            ...
            System.out.println("\nGeneros");
            respuesta.getPreferenciasGeneros().forEach(genero -> System.out.println(
                    genero.getNombreGenero() + " Cantidad de veces escuchado: " + genero.getNumeroPreferencias()));
            System.out.println("\nArtistas");
            respuesta.getPreferenciasArtistas().forEach(artista -> System.out.println(
                    artista.getNombreArtista() + " Cantidad de veces escuchado: " + artista.getNumeroPreferencias()));
